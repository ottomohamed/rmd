    ...
    <div className="max-w-4xl mx-auto py-16 px-6 text-right animate-in fade-in duration-1000" dir="rtl">
      ...
      <div className="text-center mb-16 relative">
        ...
        <h1 className="text-5xl md:text-7xl font-black font-sans tracking-tighter mb-6 leading-tight">
          خط التحريري <br /> <span className="text-emerald-700">& سياسة الخصوصية</span>
        </h1>
        ...
        <p className="text-xl text-gray-500 dark:text-gray-400 font-medium leading-relaxed max-w-2xl mx-auto italic">
          "مغرب 24: منبر لنشر النور والأمل، يصوت عن مقالات الممولة وتوابعه."
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-12">
        ...
        <section className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-8 md:p-12 rounded-[2.5rem] shadow-sm relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-8 justify-end">
            <h2 className="text-3xl font-black font-sans">مثاقنا التحريري</h2>
          ...
          <div className="space-y-8 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                ...
                <p>تدعو "مغرب 24" للدفاع عن الثوابت المملوكة المغربية على رأس أولوياتها، وعليه فإننا نحرص على خدمة القضية الوطنية العادلة ونشر الوعي بقدسية هذه الثوابت.</p>
              </div>
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                ...
                <p>نؤمن في جريدتنا أنه لا توجد خطوط حمراء في النقاش البنّاء ولكن يجب الحفاظ على احترام القانون والأدب والاحتراام واللياقة الأدبية المتعارف عليها.</p>
              </div>
              <CheckCircle2 className="w-6 h-6 text-emerald-600 mt-1 flex-shrink-0" />
            </div>
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                ...
                <p>نسعى لأن نكون منبرا ينشر النور ويبعث الأمل في نفوس المغاربة، بعيداً عن صحافة الإثارة أو زرع اليأس. نحن نبحث عن الإيجابية ونبني على المنجزات الوطنية.</p>
              </div>
              <CheckCircle2 className="w-6 h-6 text-emerald-600 mt-1 flex-shrink-0" />
            </div>
          </div>
        ...
        <section className="bg-gray-50 dark:bg-slate-900/50 border border-gray-100 dark:border-slate-800 p-8 md:p-12 rounded-[2.5rem] shadow-sm">
          ...
          <div className="space-y-6 text-gray-600 dark:text-gray-400">
            <p>تلتزم "مغرب 24" بحماية خصوصية زوارها ومساهميها وفقاً للقوانين المعمول بها. نحن نجمع فقط البيانات الضرورية لتحسين تجربة المستخدم وتسهيل التواصل مع مساهمينا في قسـم "مساهمات القراء".</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 dark:border-slate-800">
                ...
                <p className="text-sm">الاسم والبريد الإلكتروني عند إرسال المقالات أو التعليقات، بالاضافة إلى البيانات التقنية المجهرية لتحسين أداء الموقع.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-gray-100 dark:border-slate-800">
                <h4 className="font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2 justify-end">
                   مشاركة البيانات <Scale className="w-4 h-4 text-gold-500" />
                </h4>
                <p className="text-sm">لا نقوم ببيع أو مشاركة بياناتكم الشخصية مع أي طرف ثالث لأغراض تجارية أو إعلانية.</p>
              </div>
            </div>
          </div>
        </section>
