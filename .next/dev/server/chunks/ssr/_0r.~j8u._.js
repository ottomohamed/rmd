    ...
    return {
        messages: (await __turbopack_context__.f({
            "../messages/ar/common.json": {
                id: ()=>"[project]/messages/ar/common.json.[json].cjs [app-rsc] (ecmascript, async loader)",
                module: ()=>__turbopack_context__.A("[project]/messages/ar/common.json.[json].cjs [app-rsc] (ecmascript, async loader)")
            }
        }).import(`../messages/${locale}/common.json`)).default
    };
});
}),
...
//# sourceMappingURL=_0r.~j8u._.js.map